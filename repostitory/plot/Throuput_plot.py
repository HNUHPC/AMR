...
plt.legend( (rects1[0], rects2[0],rects3[0],rects4[0]), ('Z-order', 'Z-order+zMesh',"Hilbert","Hilbert+zMesh") ,ncol=2, bbox_to_anchor=(1.8, 1.8),prop=font)
...
ax.set_xlabel("(d) SZ decompression",{'family' : 'Times New Roman', 'size'   : 36})
plt.tight_layout()

plt.savefig(name_hat+'Throuput.pdf', format='pdf',bbox_inches="tight")
plt.show()
